...
| Scanner comments, display modes, disabled/non-blocking jobs, invalid actions, or non-integration triggers | Multiple providers                               | SEC-003 repository alternative does not pass                   |
...
| Placeholder owner, vague prose, or missing authority                                                      | Conventional ownership formats                   | GOV-002 does not pass                                          |
